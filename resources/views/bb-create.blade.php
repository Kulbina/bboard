...
@section('content')
    <form action="{{ route('bb.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input name="title" id="txtTitle" class="form-control"></div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input name="price" id="txtPrice" class="form-control"></div>
        <input type="submit" class="btn btn-primary" value="Добавить"></form>
@endsection('content')
